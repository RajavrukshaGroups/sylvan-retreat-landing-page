...
export const EnquiryModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 animate-fadeIn">
      <div className="bg-[#0b2415] border border-[#e6c278]/50 rounded-2xl max-w-lg w-full p-6 sm:p-8 relative shadow-2xl overflow-hidden">
        ...
        {!isMandatory && (
          <button
            onClick={onClose}
            className="absolute top-4 right-4 p-2 text-stone-400 hover:text-white rounded-full bg-[#081a0e] border border-stone-700 cursor-pointer"
        ...
        <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center gap-2 bg-[#07190e] p-3 rounded-lg border border-stone-800">
              ...
              />
              <label htmlFor="pickup" className="text-xs text-stone-300 cursor-pointer">
            ...
            >
              ...
              <span>{isSubmitting ? 'Submitting...' : 'CONFIRM & GET DETAILS'}</span>
            </button>
          </form>
        </div>
