...
export const SiteLocationMap = ({ onOpenEnquiry }) => {
  ...
  const landmarks = [
    ...
    {
      name: "Kempegowda Int. Airport (KIAL)",
      distance: "28 KM",
      time: "25 Mins",
      category: "Transit",
      icon: Plane,
    ...
    {
      name: "Aerospace SEZ & Boeing Plant",
      distance: "22 KM",
      time: "22 Mins",
      category: "IT & Hubs",
      icon: Building,
    ...
    {
      name: "Aster CMI & Manipal Hospitals",
      distance: "32 KM",
      time: "35 Mins",
      category: "Education & Health",
      icon: Hospital,
    ...
    {
      name: "Phoenix Mall of Asia & RMZ Mall",
      distance: "30 KM",
      time: "32 Mins",
      category: "Education & Health",
      icon: ShoppingBag,
    ...
    },
    {
      ...
      category: "Transit",
      icon: Navigation,
      color: "border-stone-600 text-stone-800 bg-stone-100",
    },
  ];
  ...
  return (
    <section
      id="location"
      className="py-16 bg-[#f5f1e8] text-white border-y border-[#e6c278]/30 relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-stone-900 text-sm sm:text-base max-w-2xl mx-auto font-light">
            Strategically located in Doddaballapura, North Bangalore — seamless
            connection to KIAL Airport, Highway SH-09, Nandi Hills, and ISHA
            Foundation.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mb-12">
          ...
          <div className="lg:col-span-7 bg-[#0b2415] border border-[#e6c278]/40 rounded-2xl p-4 sm:p-6 shadow-2xl flex flex-col justify-between relative group">
            ...
            {/* <p className="text-[11px] text-stone-400 mt-3 text-center">
              📍 Directly accessible via State Highway-09 & Satellite Town Ring
              Road (STRR).
            </p> */}
          </div>
          ...
          <div className="lg:col-span-5 bg-[#0b2415] border border-[#e6c278]/30 rounded-2xl p-6 shadow-xl flex flex-col justify-between">
            ...
            <div className="pt-4 border-t border-[#e6c278]/20 flex flex-col gap-2">
              ...
              <div className="text-center text-[10px] text-stone-400">
                🚗 Free pick-up & drop from Hebbal, Yelahanka & Bangalore
                Airport Road
              </div>
            </div>
          </div>
      ...
      {isMapModalOpen && (
        <div
          className="fixed inset-0 z-50 bg-black/95 backdrop-blur-md flex items-center justify-center p-1 animate-fadeIn overflow-hidden"
        ...
        >
          ...
          >
            ...
            <img
              src={sitema}
              alt="Samrudhi Sylvan Retreat Location & Route Map"
              className="block h-auto max-h-[97vh] w-auto max-w-[98vw] object-contain rounded-xl shadow-2xl"
            />

            {/* Close Button */}
            <button
              onClick={() => setIsMapModalOpen(false)}
              className="absolute top-3 right-3 z-20 w-11 h-11 flex items-center justify-center rounded-full bg-black/80 border border-white/30 text-white hover:bg-[#e6c278] hover:text-[#081a0e] transition-all cursor-pointer shadow-xl"
